...
getLibDir = catchIO (getEnv "jurandir_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "jurandir_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "jurandir_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "jurandir_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "jurandir_sysconfdir") (\_ -> return sysconfdir)

...
/* package jurandir-0.1.0.0 */
#ifndef VERSION_jurandir
#define VERSION_jurandir "0.1.0.0"
#endif /* VERSION_jurandir */
#ifndef MIN_VERSION_jurandir
#define MIN_VERSION_jurandir(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_jurandir */
...
#define CURRENT_COMPONENT_ID "jurandir-0.1.0.0-7VCc8QnijHGFjuclmizzAW-jurandir"
